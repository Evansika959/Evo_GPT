  ...
  Inputs.Resize({ G5, G4, G3, E2, L2, G1, E1s, L0 });
  Outputs.Resize({ G5, G4, G3, D3s, D2, L2, G1, L0 });
  ...
  Inputs.AddTileLevel(G5*G4*G3*E2*L2*G1*E1s*L0*1, G5*G4*G3*E2*L2*G1*E1s*L0*1, 1, 1 * kBackingStoreLatency);
  Inputs.BindCurrentTileLevel("DRAM", 1);
  Outputs.AddTileLevel(G5*G4*G3*D3s*D2*L2*G1*L0*1, G5*G4*G3*D3s*D2*L2*G1*L0*1, 1, 1 * kBackingStoreLatency);
                ...
                t_for(g1, 0, G1); {
                  s_for(e1s, 0, E1s); {
                    ...
                    t_for(l0, 0, L0); {
                      ...
                      Inputs[g5][g4][g3][e2][l2][g1][e1s][l0]; // read-only
                      Outputs[g5][g4][g3][d3s][d2][l2][g1][l0]; // read-write
