  ...
  Weights.Resize({ D5, G4, G3, D3s, D2, E2, G1, E1s });
  ...
  // DRAM tiles 
  Weights.AddTileLevel(D5*G4*G3*D3s*D2*E2*G1*E1s*1, D5*G4*G3*D3s*D2*E2*G1*E1s*1, 1, 1 * kBackingStoreLatency);
                ...
                t_for(g1, 0, G1); {
                  s_for(e1s, 0, E1s); {
                    ...
                    t_for(l0, 0, L0); {
                      ...
                      Weights[d5][g4][g3][d3s][d2][e2][g1][e1s]; // read-only
