  ...
  Weights.Resize({ E5, D5, E4, G3, D3s, D2, G1, E1s });
  ...
  // DRAM tiles 
  Weights.AddTileLevel(E5*D5*E4*G3*D3s*D2*G1*E1s*1, E5*D5*E4*G3*D3s*D2*G1*E1s*1, 1, 1 * kBackingStoreLatency);
                ...
                t_for(g1, 0, G1); {
                  s_for(e1s, 0, E1s); {
                    ...
                    t_for(l0, 0, L0); {
                      ...
                      Weights[e5][d5][e4][g3][d3s][d2][g1][e1s]; // read-only
